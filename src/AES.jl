...
type AES256
    ...
    AES256()=new(Array{UInt8}(32),Array{UInt8}(32),Array{UInt8}(32))
end
...
#tests!!!!!!!
function aesExpandEncKey(k::Array{UInt8}, rc::Array{UInt8}) 
    i::UInt8 = 0
...
#tests!!!!!!!
function aesExpandDecKey(k::Array{UInt8}, rc::Array{UInt8}) 
    i::UInt8 = 0
...
#tests!!!!!!!
function AES256Init(ctx::AES256, k::Array{UInt8})
    rcon::UInt8 = 1
    i::UInt8 = 0
    ...
    for i in 8:-1:1
        aesExpandEncKey(ctx.deckey, rcon)
    end
end
#!!!!!!!!!!!!
